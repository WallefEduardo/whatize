...
const useStyles = makeStyles((theme) => ({
  ...
  ntButtonTKC: {
    '--btnPwaTicket': theme.mode === 'light' ? '#25B6E8' : '#25B6E8',
    '--brancoBtnPwa': theme.mode === 'light' ? '#fff' : '#d1d1d1',
    '&:hover': {
      '--btnPwaTicket': theme.mode === 'light' ? '#111416' : '#3d3d3d',
    },
  },
  ntTituloTKC: {
...
const PWAInstallPrompt = () => {
  ...
  return (
    <>
      ...
      <span className={`ntSubTitulo ${classes.ntSubTituloTKC}`}>
        Organize, acompanhe e resolva atendimentos com agilidade. O Talk Chat facilita seu <br />trabalho e aumenta sua produtividade!
      </span>
    </>
  );
};
