...
import { Avatar, CardHeader, Grid, TextField, Input, InputAdornment, InputLabel, IconButton, Tooltip } from "@mui/material";
							...
							<Tooltip title={
								...
								>
									<Refresh 
										sx={{ 
											fontSize: 12,
											animation: refreshingImage ? 'spin 1s linear infinite' : 'none',
											'@keyframes spin': {
