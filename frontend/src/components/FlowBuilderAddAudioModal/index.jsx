...
// MIGRAÇÃO: makeStyles → sx prop (preservando Formik + funcionalidade áudio)
const flowBuilderAudioStyles = {
  root: {
    display: "flex",
    flexWrap: "wrap"
  },
...
const FlowBuilderAddAudioModal = ({ open, onSave, onUpdate, data, close }) => {
  // MIGRAÇÃO: usando objeto de estilos direto (preservando funcionalidade áudio)
  ...
  return (
    <Box sx={flowBuilderAudioStyles.root}>
      <Dialog
        open={activeModal}
        onClose={handleClose}
        fullWidth="md"
            ...
            {!loading && (
              <>
                ...
                <Button
                  ...
                  color="primary"
                  variant="contained"
                  sx={flowBuilderAudioStyles.btnWrapper}
