...
const useStyles = makeStyles((theme) => ({
  ...
  invertedFabMenu: {
    border: "none",
    borderRadius: 8, // Define o raio da borda para 0 para remover qualquer borda
              ...
              <>
                ...
                <div style={{ marginRight: window.innerWidth < 850 && window.innerWidth > 598 ? '65px' : '0' }}>
                  ...
                  {inputMessage || showSelectMessageCheckbox ? (
                    ...
                    <div className={classes.recorderWrapper} style={{ display: 'flex', justifyContent: 'space-between' }}>
                      <IconButton
