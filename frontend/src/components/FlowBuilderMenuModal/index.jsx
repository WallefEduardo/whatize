...
// MIGRAÇÃO: makeStyles → sx prop (preservando Formik)
const flowBuilderMenuStyles = {
  root: {
    display: "flex",
    flexWrap: "wrap"
  },
...
const FlowBuilderMenuModal = ({ open, onSave, onUpdate, data, close }) => {
  // MIGRAÇÃO: usando objeto de estilos direto
  ...
  return (
    <Box sx={flowBuilderMenuStyles.root}>
      <Dialog
        open={activeModal}
        onClose={handleClose}
        fullWidth="md"
        ...
        <Stack>
          <Stack dividers style={{ gap: "8px", padding: "16px" }}>
            <TextField
              ...
              sx={flowBuilderMenuStyles.textField}
              style={{ width: "100%" }}
            />
          ...
          <DialogActions>
            ...
            <Button
              ...
              color="primary"
              variant="contained"
              sx={flowBuilderMenuStyles.btnWrapper}
