...
export function PlansManagerGrid(props) {
    ...
    const renderTicketLimits = (row) => {
        return row.ticketLimit > 0 ? row.ticketLimit : '-';
    };
            ...
            >
                <TableHead>
                    <TableRow>
                        ...
                        <TableCell align="center">Limite de Tickets</TableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
                    {records.map((row) => (
                        <TableRow key={row.id}>
                            ...
                            <TableCell align="center">{renderTicketLimits(row)}</TableCell>
                        </TableRow>
                    ))}
                </TableBody>
            </Table>
...
export default function PlansManager() {
    ...
    const handleSelect = (data) => {
        ...
        // Formatar o valor para exibição com vírgula como separador decimal
        let formattedAmount = data.amount || 0;
        if (typeof formattedAmount === 'number') {
            formattedAmount = formattedAmount.toLocaleString('pt-BR', { 
