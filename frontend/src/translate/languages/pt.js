    ...
    translations: {
      ...
      tagModal: {
        title: {
          add: "Nova Tag",
          edit: "Editar Tag",
          addKanban: "Nova seção",
          editKanban: "Editar seção",
        },
        form: {
          name: "Nome",
          color: "Cor",
          timeLane: "Tempo em horas para redirecionar para seção",
          nextLaneId: "Seção",
          greetingMessageLane: "Mensagem de saudação da seção",
          rollbackLaneId: "Voltar para seção após retomar atendimento"
        },
        buttons: {
          okAdd: "Adicionar",
          okEdit: "Salvar",
        ...
        successKanban: "Seção salva com sucesso.",
      },
      fileModal: {
        title: {
      ...
      ticketsList: {
        ...
        noTicketsTitle: "Tudo limpo!",
        noTicketsMessage:
          "Nenhum ticket encontrato com o filtro ou termo pesquisado",
        noQueue: "Sem Fila",
        buttons: {
          accept: "Aceitar",
          cancel: "Cancelar",
      ...
      tagsKanban: {
        ...
        confirmationModal: {
          deleteTitle: "Você tem certeza que quer excluir esta Seção?",
          deleteMessage: "Esta ação não pode ser revertida.",
        },
        table: {
          name: "Nome",
      ...
      messagesInput: {
        placeholderPrivateMessage:
          "Digite ou / para respostas rápidas",
        placeholderOpen:
          "Digite ou / para respostas rápidas",
        placeholderClosed:
      ...
      backendErrors: {
        ...
        ERR_EDITING_WAPP_MSG: "Erro ao processar transferência do ticket. Tente novamente em alguns segundos.",
