...
const useStyles = () => ({
  ...
  tab: {
    minWidth: "auto",
    width: "auto",
    padding: /* theme.spacing reference */),
    borderRadius: 8,
    transition: "0.3s",
    borderWidth: "1px",
    borderStyle: "solid",
    ...
    [/* theme.breakpoints reference */
      fontSize: "0.9rem",
      padding: /* theme.spacing reference */),
      marginRight: /* theme.spacing reference */),
      marginLeft: /* theme.spacing reference */),
    },
    [/* theme.breakpoints reference */
      fontSize: "0.8rem",
      padding: /* theme.spacing reference */),
    ...
    "&$selected": {
      color: "#FFF",
      backgroundColor: /* theme.palette reference */,
    },
  },
  tabIndicator: {
    borderWidth: "2px",
    ...
    height: 6,
    bottom: 0,
    color: /* theme.mode */ === "light" ? /* theme.palette reference */,
  },
  container: {
    paddingTop: 8,
  ...
  cardAvatar: {
    ...
    width: /* theme.spacing reference */),
    height: /* theme.spacing reference */),
  },
  cardTitle: {
    fontSize: "18px",
    color: blue[700],
                  ...
                  <Grid2 container width="100%" justifyContent="center">
                    ...
                    >
                      <Tab classes={{ root: classes.tab }}
                        style={{ color: /* theme.palette reference */}}
                        value="Indicadores"
